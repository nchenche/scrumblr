...
// let saddAsync, sismemberAsync, getAsync, setAsync, delAsync, sremAsync, smembersAsync, hgetAsync, hsetAsync, hdelAsync, existsAsync, delKeyAsync;
...
const db = {
	...
	_getRoomOwner: async function(room) {
		try {
	...
	deleteUserRoom: async function(user, room, callback) {
		...
		try {
			...
			const roomParticipants = await this.getRoomParticipants(room);
