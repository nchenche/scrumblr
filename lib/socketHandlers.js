        ...
        client.on('message', function (message) {
            ...
            switch (message.action) {
                ...
                case 'createCard':
                    ...
                    getRoom(client, function (room) {
                        createCard(db, room, clean_data.id, clean_data.text, clean_data.x, clean_data.y, clean_data.rot, clean_data.colour);
                    });
...
function createCard(db, room, id, text, x, y, rot, colour) {
    var card = {
        id: id,
        colour: colour,
        rot: rot,
...
function joinRoom(client, data, db, callback) {
    ...
    db.setRoomOwner(data.room, data.user, (response) => {
        if (!response.success) {
